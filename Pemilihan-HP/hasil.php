			...
			<div class="container">
				...
				<div class="nav-wrapper">
					...
					<ul class="left" style="margin-left: -52px;">
                        <li><a href="">SPK METODE TOPSISS</a></li>
                    </ul>
				</div>
	...
	<div style="background-color: #87AAAA">
		<div class="container">
			<div class="section-card" style="padding: 20px 0px">
				...
				<center>
					<h4 class="header" style="margin-left: 24px; margin-bottom: 0px; margin-top: 24px; color: #C9CCD5;">HASIL REKOMENDASI SMARTPHONE</h4>
				</center>
				<ul>
					<li>
						<div class="row">
				...
				<center>
					<h4 class="header" style="margin-left: 24px; margin-bottom: 0px; margin-top: 24px; color: #C9CCD5;">Matriks ternormalisasi, R:</h4>
				</center>
				<ul>
					<li>
						<div class="row">
					...
					<center>
						<h4 class="header" style="margin-left: 24px; margin-bottom: 0px; margin-top: 24px; color: #C9CCD5;">BOBOT (W)</h4>
					</center>
					<ul> 
						<li>
							<div class="row">
					...
					<center>
						<h4 class="header" style="margin-left: 24px; margin-bottom: 0px; margin-top: 24px; color: #C9CCD5;">Matriks ternormalisasi terbobot, Y:</h4>
					</center>
					<ul>
						<li>
							<div class="row">
						...
						<center>
							<h4 class="header" style="margin-left: 24px; margin-bottom: 0px; margin-top: 24px; color: #C9CCD5;">Matrik Solusi ideal positif dan negatif
							</h4>
						</center>
						<ul>
							<li>
						...
						<center>
							<h4 class="header" style="margin-left: 24px; margin-bottom: 0px; margin-top: 24px; color: #C9CCD5;">Jarak antara nilai terbobot setiap alternatif terhadap solusi ideal positif												
							</h4>
						</center>
						<ul>
							<li>
						...
						<center>
							<h4 class="header" style="margin-left: 24px; margin-bottom: 0px; margin-top: 24px; color: #C9CCD5;">Nilai Preferensi untuk Setiap alternatif (V)												
							</h4>
						</center>
						<ul>
							<li>
						...
						<center>
							<h4 class="header" style="margin-left: 24px; margin-bottom: 0px; margin-top: 24px; color: #C9CCD5;">Nilai Preferensi tertinggi
							</h4>
						</center>
						<ul>
							<li>
